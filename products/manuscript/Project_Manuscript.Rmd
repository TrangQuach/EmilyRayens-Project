...
```{r resulttable2,  fig.cap='Table 2: Summary of Characteristics by Vaccine Status', echo=FALSE}
...
```{r resultfigure4,  fig.cap='Figure 4: Survival Curve from PCP', echo=FALSE}
...
```{r resultfigure5,  fig.cap='Figure 5: Survival Curve from Colonization', echo=FALSE}
...
```{r resultfigure6,  fig.cap='Table 3: Relative Risk', echo=FALSE}
...
This analysis included several limitations, the first of which is that this data set was relatively small with incomplete individual data points. 
...
## Conclusions
Experimental vaccination reduces the incidence of _Pneumocystis_ pneumonia but doesn't reduce the incidence of Pc colonization. 
